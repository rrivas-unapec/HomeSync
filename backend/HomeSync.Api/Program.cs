...
using HomeSync.Api.Middleware;
using HomeSync.Business.Extensions;
using HomeSync.DataAccess.Extensions;
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "HomeSync API", Version = "v1" });
