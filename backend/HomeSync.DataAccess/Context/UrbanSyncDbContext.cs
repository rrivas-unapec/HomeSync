...
using HomeSync.DataAccess.Configurations;
using HomeSync.Domain.Entities;

namespace HomeSync.DataAccess.Context;

public class HomeSyncDbContext : DbContext
{
    public HomeSyncDbContext(DbContextOptions<HomeSyncDbContext> options) : base(options)
    {
    }
